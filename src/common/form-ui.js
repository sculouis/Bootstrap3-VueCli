...
/* ------------【 簽核紀錄動態 】------------ */
$(function () {
    $("#record-close-bt").hide(0);
    $(".record-show-box").hide(0);

    $("#record-open-bt").on("click", function () {
        $(this).hide(0);
        $("#record-close-bt").show(0);
        $(".record-show-box").show(300);
    });
    $("#record-close-bt").on("click", function () {
        $(this).hide(0);
        $("#record-open-bt").show(0);
        $(".record-show-box").hide(20);
    });
});
...
//錨點滑動
$(function () {
    $(document).on('click', '#syi', function () {
...
$(function () {
    ...
    $(".recode-bt-show").on("click", function () {
        $(".recode-bt-show").hide(0);
        $(".recode-bt-hide").show(0);
        $("#recode-box-CBP").show(120)
    });

    $(".recode-bt-hide").on("click", function () {
        $(".recode-bt-show").show(0);
        $(".recode-bt-hide").hide(0);
        $("#recode-box-CBP").hide(120)
